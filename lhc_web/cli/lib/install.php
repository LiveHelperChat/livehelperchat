...
class Install
{
    function __construct($yaml_file)
    {
        ...
        $this->yaml = yaml_parse_file($yaml_file);
    }
    ...
    function step1() {
        $Errors = array();
        if (!is_writable("cache/aaaacacheconfig"))
    ...
    function step2() {
        ...
        # Recover information from yaml file
    ...
    function step4() {
        print("Installation is complete. You can start by adding users and departments.");
    }
