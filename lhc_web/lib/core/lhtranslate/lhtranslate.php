...
class erLhcoreClassTranslate
{
    ...
    public static function setChatLanguages(erLhcoreClassModelChat $chat, $visitorLanguage, $operatorLanguage, $params = array())
    {
        ...
        if (key_exists($visitorLanguage, $supportedLanguages)) {
            ...
            $stmt = $db->prepare('SELECT msg FROM lh_msg WHERE chat_id = :chat_id AND user_id = 0 ORDER BY id ASC LIMIT 5 OFFSET 0');
    ...
    public static function getSupportedLanguages($returnOptions = false)
    {
        ...
        if (isset($translationData['translation_handler'])) {
            ...
            if ($translationData['translation_handler'] == 'bing') {
                ...
                $options['ace'] = 'Acehnese';
                $options['af'] = 'Afrikaans';
                $options['an'] = 'Aragonese';
                $options['ar'] = 'Arabic';
                $options['as'] = 'Assamese';
                $options['ay'] = 'Aymara';
                $options['az'] = 'Azerbaijani';
                ...
                $options['xh'] = 'Xhosa';
                $options['yi'] = 'Yiddish';
                $options['yue'] = 'Cantonese';
                $options['zh'] = 'Chinese';
                $options['zh-hans'] = 'Chinese (Simplified)';
                $options['zh-hant'] = 'Chinese (Traditional)';
                $options['zu'] = 'Zulu';
            }
        }
        ...
        if (isset($translationData['translation_handler'])) {
            if($translationData['translation_handler'] == 'bing') {
               ...
               return erLhcoreClassTranslateAWS::detectLanguage([
                ...
                return erLhcoreClassTranslateDeepL::detectLanguage($translationData['deepl_api_key'], $text);
            }
        }
    }
    ...
    public static function collectPathsToTranslate($msg, $fromLanguage, $toLanguage)
    {
        ...
        if (isset($elements['content']['html']['content']) && $elements['content']['html']['content'] != '') {
            $pathsTranslate[] = [
                ...
                'target' => $elements['content']['html']['content']
            ];
        }
