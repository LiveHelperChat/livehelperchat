...
class erLhcoreClassGenericBotWorkflow {
    ...
    public static function setLastMessageId($chat, $messageId, $isBot = false, $params = []) {
        ...
        $stmt->bindValue(':has_unread_messages', (($chat->status == erLhcoreClassModelChat::STATUS_BOT_CHAT || $chat->status == erLhcoreClassModelChat::STATUS_CLOSED_CHAT || (isset($params['ignore_times']) && $params['ignore_times'] === true)) ? 0 : 1), PDO::PARAM_INT);
