...
$fields = array(
    ...
    'need_help_bcolor' => array(
                ...
                'pending_join_queue' => array(
   						...
   						'main_attr_lang' => 'bot_configuration_array',
   						'translatable' => true,
   						'trans' => erTranslationClassLhTranslation::getInstance()->getTranslation('abstract/widgettheme','Text when user starts a chat and is waiting for operator to join a chat. Only if queue is > 1. {number}, {avg_wait_time}, {avg_wait_time__string if more than one minute wait time}'),
