        	...
        	for ($i = 0; $i < 12;$i++) {
        		...
        		if (!isset($filter['filtergte']['time']) || $filter['filtergte']['time'] <= $dateUnix || date('Ym',$filter['filtergte']['time']) == date('Ym',$dateUnix))
                {
                    $numberOfChats[$dateUnix] = array (
                            ...
                            'bot' 			    => (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filter' => array('status' => erLhcoreClassModelChat::STATUS_BOT_CHAT),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m\') = '. date('Ym',$dateUnix))))),
                            ...
                            'chatinitdefault' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filternot' => array('last_user_msg_time' => 0,'status_sub' => erLhcoreClassModelChat::STATUS_SUB_PRELOAD),'filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_DEFAULT),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m\') = '. date('Ym',$dateUnix))))),
                            'chatinitbotdefault' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filternot' => array('last_user_msg_time' => 0,'status_sub' => erLhcoreClassModelChat::STATUS_SUB_PRELOAD),'filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_BOT_DEFAULT),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m\') = '. date('Ym',$dateUnix))))),
                            'chatinitbotoffline' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filternot' => array('last_user_msg_time' => 0,'status_sub' => erLhcoreClassModelChat::STATUS_SUB_PRELOAD),'filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_BOT_OFFLINE),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m\') = '. date('Ym',$dateUnix))))),
                            'chatinitoffline' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_OFFLINE_MESSAGE),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m\') = '. date('Ym',$dateUnix))))),

                            'chatinitpreload' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filternot' => array('status_sub' => erLhcoreClassModelChat::STATUS_SUB_PRELOAD),'filterin' => array('chat_initiator' => array(erLhcoreClassModelChat::CHAT_INITIATOR_DEFAULT,erLhcoreClassModelChat::CHAT_INITIATOR_BOT_DEFAULT,erLhcoreClassModelChat::CHAT_INITIATOR_BOT_OFFLINE)),'filter' => array('last_user_msg_time' => 0), 'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m\') = '. date('Ym',$dateUnix))))),

                            'chatinitproact' => (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filternot' => array('last_user_msg_time' => 0), 'filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_PROACTIVE),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m\') = '. date('Ym',$dateUnix))))),
                            'chatinitproactunresponded' => (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filter' => array('last_user_msg_time' => 0,'chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_PROACTIVE),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m\') = '. date('Ym',$dateUnix))))),

                            // Responded bot invitations
                            'chatinitproactbot' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filtergt' => array('last_user_msg_time' => 0),'filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_BOT),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m\') = '. date('Ym',$dateUnix))))),
                            'chatinitproactbotunresponded' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filter' => array('last_user_msg_time' => 0,'chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_BOT),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m\') = '. date('Ym',$dateUnix))))),
                    );
                }
        }
            ...
            for ($i = 0; $i < $limitDays;$i++) {
                ...
                if (!isset($filter['filtergte']['time']) || $filter['filtergte']['time'] <= $dateUnix || date('Ym',$filter['filtergte']['time']) == date('Ym',$dateUnix))
                {
                    $numberOfChats[$dateUnix] = array (
                        ...
                        'chatinitdefault' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filternot' => array('last_user_msg_time' => 0,'status_sub' => erLhcoreClassModelChat::STATUS_SUB_PRELOAD),'filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_DEFAULT),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%v\') = '. date('YW',$dateUnix))))),
                        'chatinitbotdefault' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filternot' => array('last_user_msg_time' => 0,'status_sub' => erLhcoreClassModelChat::STATUS_SUB_PRELOAD),'filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_BOT_DEFAULT),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%v\') = '. date('YW',$dateUnix))))),
                        'chatinitbotoffline' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filternot' => array('last_user_msg_time' => 0,'status_sub' => erLhcoreClassModelChat::STATUS_SUB_PRELOAD),'filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_BOT_OFFLINE),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%v\') = '. date('YW',$dateUnix))))),
                        'chatinitoffline' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_OFFLINE_MESSAGE),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m\') = '. date('YW',$dateUnix))))),

                        'chatinitpreload' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filternot' => array('status_sub' => erLhcoreClassModelChat::STATUS_SUB_PRELOAD),'filterin' => array('chat_initiator' => array(erLhcoreClassModelChat::CHAT_INITIATOR_DEFAULT,erLhcoreClassModelChat::CHAT_INITIATOR_BOT_DEFAULT,erLhcoreClassModelChat::CHAT_INITIATOR_BOT_OFFLINE)),'filter' => array('last_user_msg_time' => 0), 'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%v\') = '. date('YW',$dateUnix))))),

                        'chatinitproact' => (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filternot' => array('last_user_msg_time' => 0), 'filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_PROACTIVE),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%v\') = '. date('YW',$dateUnix))))),
                        'chatinitproactunresponded' => (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filter' => array('last_user_msg_time' => 0,'chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_PROACTIVE),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%v\') = '. date('YW',$dateUnix))))),

                        // Responded bot invitations
                        'chatinitproactbot' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filtergt' => array('last_user_msg_time' => 0),'filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_BOT),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%v\') = '. date('YW',$dateUnix))))),
                        'chatinitproactbotunresponded' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filter' => array('last_user_msg_time' => 0,'chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_BOT),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%v\') = '. date('YW',$dateUnix))))),
                    );
                }
            }
        ...
        if ($statusWorkflow === false) {
        	...
        	for ($i = 0; $i < $limitDays;$i++) {
        		...
        		$numberOfChats[$dateUnix] = array (
        		        ...
        		        'bot' 		=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filter' => array('status' => erLhcoreClassModelChat::STATUS_BOT_CHAT),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m%d\') = '. date('Ymd',$dateUnix))))),
        				...
        				'chatinitdefault' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filternot' => array('last_user_msg_time' => 0,'status_sub' => erLhcoreClassModelChat::STATUS_SUB_PRELOAD),'filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_DEFAULT),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m%d\') = '. date('Ymd',$dateUnix))))),
        				'chatinitbotdefault' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filternot' => array('last_user_msg_time' => 0,'status_sub' => erLhcoreClassModelChat::STATUS_SUB_PRELOAD),'filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_BOT_DEFAULT),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m%d\') = '. date('Ymd',$dateUnix))))),
        				'chatinitbotoffline' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filternot' => array('last_user_msg_time' => 0,'status_sub' => erLhcoreClassModelChat::STATUS_SUB_PRELOAD),'filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_BOT_OFFLINE),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m%d\') = '. date('Ymd',$dateUnix))))),
        				'chatinitoffline' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filternot' => array('last_user_msg_time' => 0,'status_sub' => erLhcoreClassModelChat::STATUS_SUB_PRELOAD),'filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_OFFLINE_MESSAGE),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m%d\') = '. date('Ymd',$dateUnix))))),

                        'chatinitpreload' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filternot' => array('status_sub' => erLhcoreClassModelChat::STATUS_SUB_PRELOAD),'filterin' => array('chat_initiator' => array(erLhcoreClassModelChat::CHAT_INITIATOR_DEFAULT,erLhcoreClassModelChat::CHAT_INITIATOR_BOT_DEFAULT,erLhcoreClassModelChat::CHAT_INITIATOR_BOT_OFFLINE)),'filter' => array('last_user_msg_time' => 0),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m%d\') = '. date('Ymd',$dateUnix))))),

                        'chatinitproact' 	=> (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filternot' => array('last_user_msg_time' => 0),'filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_PROACTIVE),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m%d\') = '. date('Ymd',$dateUnix))))),
                        'chatinitproactunresponded' => (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filter' => array('last_user_msg_time' => 0,'chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_PROACTIVE),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m%d\') = '. date('Ym',$dateUnix))))),

        				'chatinitproactbot' => (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filtergt' => array('last_user_msg_time' => 0),'filter' => array('chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_BOT),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m%d\') = '. date('Ymd',$dateUnix))))),
        				'chatinitproactbotunresponded' => (int)erLhcoreClassChat::getCount(array_merge_recursive($departmentFilter,$filter,array('filter' => array('last_user_msg_time' => 0,'chat_initiator' => erLhcoreClassModelChat::CHAT_INITIATOR_BOT),'customfilter' =>  array('FROM_UNIXTIME(time,\'%Y%m%d\') = '. date('Ymd',$dateUnix))))),
        		);
        	}
