            ...
            switch ($var) {
                ...
                case 'user_status_front':
                    ...
                    if ($this->lsync > 0) {
                        ...
                        $this->user_status_front =  (time() - $timeout > $this->lsync || in_array($this->status_sub,array(self::STATUS_SUB_SURVEY_SHOW,self::STATUS_SUB_USER_CLOSED_CHAT))) ? 1 : 0;
...
namespace {
    class erLhcoreClassModelChat extends \LiveHelperChat\erLhcoreClassModelChat {
