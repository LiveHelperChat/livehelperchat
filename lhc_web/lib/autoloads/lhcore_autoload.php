...
return array (
        ...
        'erLhcoreClassTransfer' => 'core/lhcore/lhtransfer.php',
        ...
        'erLhcoreClassChat'        => 'core/lhchat/lhchat.php',
        'erLhcoreClassDepartament' => 'core/lhdepartament/lhdepartament.php',
        'erLhcoreClassUserDep'     => 'core/lhdepartament/lhuserdep.php',
        
         // Models
        'erLhcoreClassModelTransfer' => 'models/lhtransfer/erlhcoreclassmodeltransfer.php',
        ...
        'erLhcoreClassModelChat' => 'models/lhchat/erlhcoreclassmodelchat.php',
        'erLhcoreClassModelmsg'  => 'models/lhchat/erlhcoreclassmodelmsg.php',
        ...
        'erLhcoreClassModelDepartament'  => 'models/lhdepartament/erlhcoreclassmodeldepartament.php',
);
