...
class _zoomImage {
    ...
    setParams(params, attributes, chatEvents) {
        ...
        this.addCss('body{overflow:hidden;}.lhc-modal {display: none; position: fixed; z-index: 2147483641 !important;padding-top: ' + (attributes.isMobile == true ? 0 : 20)  +'px;left: 0;top: 0;  width: 100%;height: 100%; overflow: auto; background-color: rgb(0,0,0);  background-color: rgba(0,0,0,0.4); }'+
