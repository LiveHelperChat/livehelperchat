...
export class UIConstructorIframe extends UIConsturctor {
    ...
    constructUIIframe(style, dir, cl, header, disableViewPort) {
        ...
        try {
            this.elmDomDoc.getElementsByTagName("head")[0].innerHTML = '<meta name="color-scheme" content="light dark" /><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />'+(disableViewPort !== true ? '<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" />' : '')+header;
