...
export class UIConstructorIframe extends UIConsturctor {
    ...
    constructUIIframe(style, dir, cl) {
        ...
        this.elmDomDoc.open();
        this.elmDomDoc.writeln('<!DOCTYPE html><html dir="'+dir+'" lang="'+cl+'"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" /></head><body></body></html>');
