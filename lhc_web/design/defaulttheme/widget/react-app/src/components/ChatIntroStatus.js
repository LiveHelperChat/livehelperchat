        ...
        return <React.Fragment>
            ...
            {!this.props.hideMessageField && <div className="d-flex flex-row border-top position-relative message-send-area">
                ...
                <div className="mx-auto w-100">
                    <textarea aria-label="Type your message here..." placeholder={this.props.placeholderMessage} readOnly="readOnly" id="CSChatMessage" rows="1" className="ps-0 no-outline form-control rounded-0 form-control rounded-start-0 rounded-end-0 border-0" />
                </div>
