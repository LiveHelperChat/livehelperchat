        ...
        return (
            <div className={className} style={{width:(this.props.chatwidget.hasIn(['proactive','data','message_width']) ? this.props.chatwidget.getIn(['proactive','data','message_width']) : 200)}} onClick={this.fullInvitation} id="id-invitation-height">
                ...
                <div className="fs14">
                    ...
                    {this.props.chatwidget.getIn(['proactive','data','photo']) && <img width="30" alt={this.props.chatwidget.getIn(['proactive','data','name_support']) || this.props.chatwidget.getIn(['proactive','data','extra_profile'])} title={this.props.chatwidget.getIn(['proactive','data','name_support']) || this.props.chatwidget.getIn(['proactive','data','extra_profile'])} className="mr-2" src={this.props.chatwidget.getIn(['proactive','data','photo'])} />}
