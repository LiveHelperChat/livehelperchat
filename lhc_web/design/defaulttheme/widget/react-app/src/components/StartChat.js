...
class StartChat extends Component {
    ...
    if (this.props.chatwidget.get('onlineData').has('fields') && !(this.props.chatwidget.hasIn(['chat_ui','show_messages_box']) && this.props.chatwidget.getIn(['onlineData','fields_visible']) == 1)) {
                ...
                return (
                    <React.Fragment>
...

                        {
                            ...
                            ||
                            (this.props.chatwidget.hasIn(['chat_ui','operator_profile']) && <div className="pt-1 pl-1 pr-1" dangerouslySetInnerHTML={{__html:this.props.chatwidget.getIn(['chat_ui','operator_profile'])}}></div>)
                        }
