    ...
    switch (action.type) {
        ...
        case ENDED_CHAT : {
            return state.set('shown',false)
                ...
                .set('chatLiveData',fromJS({'msg_to_store':[], 'lock_send' : false, 'hum': 0, 'lmsop':0, 'vtm':0, 'otm':0, 'msop':0, 'uid':0, 'status' : 0, 'status_sub' : 0, 'uw' : false, 'ott' : '', 'closed' : false, 'lfmsgid': 0, 'lmsgid' : 0, 'operator' : '', 'messages' : []}))
