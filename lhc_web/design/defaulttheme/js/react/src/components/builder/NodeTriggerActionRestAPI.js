        ...
        return (
            <div>
                ...
                <div className="form-group">
                    ...
                    <label><input type="checkbox" onChange={(e) => this.onchangeAttr({'path' : ['attr_options','no_body'], 'value' :e.target.checked})} defaultChecked={this.props.action.getIn(['content','attr_options','no_body'])} /> Do not show plain response.</label>
                </div>
