...
<li role="presentation" class="nav-item"><a class="nav-link pl-2 pr-2 pt-0 pb-0" id="map-activator" ng-click="lhc.currentPanel = 'map';lhc.current_chat_id = 0"  href="#map" aria-controls="map" role="tab" data-toggle="tab" title="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/onlineusers','Recent visitors on map');?>"><i class="material-icons mr-0">place</i></a></li>
<?php endif;?>
