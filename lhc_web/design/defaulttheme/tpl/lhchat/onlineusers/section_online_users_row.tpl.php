    	...
    	<td>
            ...
            <div style="width:90px">
    	        <div class="btn-group" role="group" aria-label="...">
    	            ...
    	            <a ng-click="online.sendMessage(ou.id)" class="btn btn-secondary btn-sm material-icons mat-100 mr-0" title="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/onlineusers','Send message');?>">chat</a>
    	            <?php endif;?>
