...
<?php elseif ($chat->status == erLhcoreClassModelChat::STATUS_BOT_CHAT) : ?>
    <i class="material-icons chat-active" title="<?php echo htmlspecialchars($chat->gbot_id);?>">android</i><?php if (!isset($hideStatusText)) : ?><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/pendingchats','Bot chat');?><?php endif; ?>
<?php endif;?>
