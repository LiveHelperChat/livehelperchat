...
<div class="btn-group" role="group" aria-label="...">
	...
	<input type="button" class="btn btn-default" onclick="$('#myModal').modal('hide');" name="CancelAlbum" value="<?=erTranslationClassLhTranslation::getInstance()->getTranslation('chat/chat','Cancel')?>"/>
</div>
