<div class="row">
	<div class="col-sm-8 pl-0 chat-main-left-column" id="chat-main-column-<?php echo $chat->id;?>">
		...
		<div class="message-container-admin">
            ...
            <?php if ($chat->status != erLhcoreClassModelChat::STATUS_OPERATORS_CHAT && $chat->user_id != erLhcoreClassUser::instance()->getUserID()) : ?><?php if (isset($writeRemoteDisabled) && $writeRemoteDisabled === true) : ?><?php $placeholderValue = erTranslationClassLhTranslation::getInstance()->getTranslation('chat/chat','You can only read a messages.')?>
