<div class="row status-row">
    <div class="columns large-3">
            ...
            <img class="action-image" align="absmiddle" onclick="lhinst.sendMail('<?php echo $chat->id?>')" src="<?php echo erLhcoreClassDesign::design('images/icons/email.png');?>" alt="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/adminchat','Send mail')?>" title="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/adminchat','Send mail')?>">
            </p>
