...
<?php if ((!isset($chat) || $chat->nick != 'Visitor') && $chat->iwh_id === 0) : ?>
...
<label><input type="checkbox" name="btype_online_user" value="on"> <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/blockedusers','Online user profile')?></label></br>
<?php endif; ?>

<?php if ($chat->email != '' && $chat->iwh_id === 0) : ?>
