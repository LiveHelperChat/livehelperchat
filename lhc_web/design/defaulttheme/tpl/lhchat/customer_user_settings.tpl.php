...
<a href="#" data-dropdown="drop2" class="tiny secondary right round button dropdown"><i class="icon-tools"></i></a>

<ul id="drop2" data-dropdown-content class="f-dropdown right widget-options">
     <?php if ( isset($chat) ) : ?>
