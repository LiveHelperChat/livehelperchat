            ...
            <div class="tab-content nav-pills-bbcode-content bbtab-content<?php if (isset($bbcodeParams['tab_prefix'])) : ?><?php echo $bbcodeParams['tab_prefix']?><?php endif; ?>">
                <?php foreach ($icons as $index => $iconGroup) : ?>
                    <div role="tabpanel" class="tab-pane bb-list<?php if ($index == 0) : ?> active<?php endif;?><?php if (isset($chat_id) && $chat_id !== null) : ?> admin-emoji<?php endif;?>" id="bbcode-smiley-<?php echo $index?><?php if (isset($bbcodeParams['tab_prefix'])) : ?><?php echo $bbcodeParams['tab_prefix']?><?php endif; ?>">
                        <?php if ($index == 0) : ?>
                            <a bbitem="true" class="rounded d-inline-block <?php if (isset($react) && $react == true) : ?>badge-light<?php else : ?>bg-secondary<?php endif;?> p-1 m-1 action-image" title="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/bbcodeinsert', 'Image'); ?>" data-promt="img" data-bb-code="img"><i class="material-icons mr-0"><?php if (isset($react) && $react == true) : ?>&#xf114;<?php else : ?>image<?php endif; ?></i></a>
                            <a bbitem="true" class="rounded d-inline-block <?php if (isset($react) && $react == true) : ?>badge-light<?php else : ?>bg-secondary<?php endif;?> p-1 m-1 action-image" title="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/bbcodeinsert', 'Link'); ?>" data-promt="url" data-bb-code=" [url=http://example.com]<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/bbcodeinsert', 'Link title'); ?>[/url] "><i class="material-icons mr-0"><?php if (isset($react) && $react == true) : ?>&#xf115;<?php else : ?>link<?php endif; ?></i></a>
                            <a bbitem="true" class="rounded d-inline-block <?php if (isset($react) && $react == true) : ?>badge-light<?php else : ?>bg-secondary<?php endif;?> p-1 m-1 action-image" title="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/bbcodeinsert', 'Bold'); ?>" data-bb-code=" [b][/b] "><strong>B</strong></a>
                            <a bbitem="true" class="rounded d-inline-block <?php if (isset($react) && $react == true) : ?>badge-light<?php else : ?>bg-secondary<?php endif;?> p-1 m-1 action-image" title="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/bbcodeinsert', 'Italic'); ?>" data-bb-code=" [i][/i] "><em>I</em></a>
                        <?php endif; ?>
                        <?php foreach ($iconGroup['icons'] as $icon) : ?><a bbitem="true" class="rounded d-inline-block <?php if (isset($react) && $react == true) : ?>badge-light<?php else : ?>bg-secondary<?php endif;?> p-1 m-1 action-image" data-bb-code="<?php echo $icon ?>"><?php echo $icon ?></a><?php endforeach; ?>
                        </ul>
