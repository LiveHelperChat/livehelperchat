...
<div class="row">
	...
	<div class="column small-12">
		<label><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('user/account','Subject');?></label>
	...
	<div class="column small-12">
		<label><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('user/account','From name');?></label>
	...
	<div class="column small-6 end">
		<label><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('user/account','Reply e-mail');?></label>
	...
	<div class="column small-6 end">
		<label><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('user/account','From e-mail');?></label>
