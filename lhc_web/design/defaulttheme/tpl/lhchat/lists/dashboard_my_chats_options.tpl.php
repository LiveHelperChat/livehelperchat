<li class="nav-item dropright ml-auto" ng-init="lhc.getToggleWidget('only_user',true);">
    <a class="nav-link dropdown-toggle pl-2 pr-2 pt-0 pb-0" data-toggle="dropdown" role="button" aria-expanded="false"><i class="material-icons mr-0">settings_applications</i></a>
