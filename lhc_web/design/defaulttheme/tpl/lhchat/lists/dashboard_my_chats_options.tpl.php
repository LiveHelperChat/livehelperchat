<nav class="float-right" ng-init="lhc.getToggleWidget('only_user',true);">
    <ul class="nav" >
        <li class="nav-item dropleft" style="line-height:1">
            <a class="nav-link dropdown-toggle pt-0 mt-0 pl-1 pr-1" data-toggle="dropdown" role="button" aria-expanded="false"><i class="material-icons mr-0">settings_applications</i></a>
