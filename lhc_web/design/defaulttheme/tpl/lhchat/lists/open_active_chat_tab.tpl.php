<nav class="float-end" ng-init="lhc.getToggleWidget('track_open_chats');lhc.getToggleWidget('group_offline_chats')">
    <ul class="nav">
        <li class="nav-item dropstart">
            <a class="nav-link dropdown-toggle text-secondary" id="menu-chat-options" data-toggle="dropdown" role="button" aria-expanded="false"><i class="material-icons me-0">settings_applications</i></a>
