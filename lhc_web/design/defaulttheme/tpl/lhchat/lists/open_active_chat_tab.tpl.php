<nav class="float-right" ng-init="lhc.getToggleWidget('track_open_chats');lhc.getToggleWidget('group_offline_chats')">
    <ul class="nav">
        <li class="nav-item dropleft">
            <a class="nav-link dropdown-toggle" id="menu-chat-options" data-toggle="dropdown" role="button" aria-expanded="false"><i class="material-icons mr-0">settings_applications</i></a>
