    ...
    <ul class="nav">
        <li class="nav-item dropend">
            ...
            <div class="dropdown-menu" role="menu">
                ...
                <a class="dropdown-item" href="#" onclick="ee.emitEvent('svelteResetFilters');" ><i class="material-icons">search_off</i><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('front/default', 'Reset widget filters'); ?></a>
