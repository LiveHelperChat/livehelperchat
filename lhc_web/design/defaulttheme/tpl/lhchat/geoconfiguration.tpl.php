...
<ul class="accordion<?php (!isset($geo_data['geo_detection_enabled']) || $geo_data['geo_detection_enabled'] == 0) ? print ' hide' : '' ?>" id="settings-geo">
  <li <?php isset($geo_data['geo_detection_enabled']) && ($geo_data['geo_service_identifier'] == 'freegeoip') ? print 'class="active"' : ''?> >
    <div class="title">
      <h5>http://freegeoip.net/static/index.html - <a target="_blank" href="http://freegeoip.net/static/index.html"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/onlineusers','See service terms and conditions'); ?></a></h5>
    </div>
    <div class="content">
  ...
  <li <?php isset($geo_data['geo_detection_enabled']) && ($geo_data['geo_service_identifier'] == 'locatorhq') ? print 'class="active"' : ''?> >
    <div class="title">
        <h5>http://www.locatorhq.com <a target="_blank" href="http://www.locatorhq.com"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/onlineusers','See service terms and conditions'); ?></a></h5>
    </div>
    <div class="content">
