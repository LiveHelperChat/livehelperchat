...
<?php else : ?>
			...
			<?php else : ?>
				...
				<?php else : ?>
					<div class="col-6 form-group">
						...
						<input autofocus="autofocus" class="form-control form-control-sm<?php if (isset($errors['nick'])) : ?> is-invalid<?php endif;?>" <?php if (isset($start_data_fields['offline_name_require_option']) && $start_data_fields['offline_name_require_option'] == 'required') : ?>aria-required="true" required<?php endif;?> aria-label="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','Enter your name');?>" placeholder="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','Enter your name');?>" type="text" name="Username" value="<?php echo htmlspecialchars($input_data->username);?>" />
					</div>
				<?php endif;?>
		    <?php endif;?>
	    <?php endif;?>
		...
		<?php else : ?>
			...
			<?php else : ?>
				<div class="col-6 form-group">
					...
					<input autofocus="autofocus" class="form-control form-control-sm<?php if (isset($errors['email'])) : ?> is-invalid<?php endif;?>" aria-required="true" required aria-label="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','Enter your email address')?>" placeholder="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','Enter your email address')?>" type="text" name="Email" value="<?php echo htmlspecialchars($input_data->email);?>" />
				</div>
			<?php endif;?>
	    <?php endif;?>
	</div>
	...
	<div class="form-group">
	   ...
	   <input class="form-control form-control-sm" autofocus="autofocus" type="file" name="File" value="" />
	</div>
	<?php endif; ?>
