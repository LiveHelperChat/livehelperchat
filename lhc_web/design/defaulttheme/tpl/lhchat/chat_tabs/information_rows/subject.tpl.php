...
<tr>
    <td colspan="2">
        ...
        <h6 class="font-weight-bold"><i class="material-icons">description</i><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/subject','Subject')?>
            <button type="button" class="btn btn-xs btn-link text-muted pb-1 pl-1" onclick="return lhc.revealModal({'url':'<?php echo erLhcoreClassDesign::baseurl('chat/subject')?>/<?php echo $chat->id?>'})"><i class="material-icons mr-0">&#xE145;</i></button>
        </h6>
