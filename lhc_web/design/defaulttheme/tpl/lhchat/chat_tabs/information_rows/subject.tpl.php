...
<tr>
    <td colspan="2">
        ...
        <h6 class="font-weight-bold py-2"><i class="material-icons">description</i><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/subject','Subject')?></h6>
