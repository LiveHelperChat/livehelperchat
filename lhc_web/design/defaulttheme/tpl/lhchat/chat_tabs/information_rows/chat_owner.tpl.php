    ...
    <td colspan="2">
        ...
        <div class="row">
            <div class="col-6 pb-1">
                <div class="text-muted" id="chat-owner-<?php echo $chat->id?>" user-id="<?php echo $chat->user_id?>" title="<?php echo htmlspecialchars(\LiveHelperChat\Models\Departments\UserDepAlias::getAlias(array('scope' => 'as_string', 'chat' => $chat)));?>">
