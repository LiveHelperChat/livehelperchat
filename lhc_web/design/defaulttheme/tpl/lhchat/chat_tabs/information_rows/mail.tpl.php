...
<tr>
    <td colspan="2" >
        <h6 class="font-weight-bold action-image" onclick="lhinst.explandCollapse('mailchat',<?php echo $chat->id?>,'mailconv/relatedtickets/<?php echo $chat->id?>');" title="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/adminchat','Collapse/Expand')?>">
