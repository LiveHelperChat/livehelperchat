...
<?php if ($chat_translation_tab_enabled == true && erLhcoreClassUser::instance()->hasAccessTo('lhtranslation','use')) : ?>  
    ...
    <li role="presentation"<?php if ($chatTabsOrderDefault == 'chat_translation_tab') print ' class="active"';?>><a href="#main-user-info-translation-<?php echo $chat->id?>" aria-controls="main-user-info-translation-<?php echo $chat->id?>" title="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/translation','Automatic translation')?>" role="tab" data-toggle="tab"><i class="icon-language"></i></a></li>
    <?php endif;?>
<?php endif;?>