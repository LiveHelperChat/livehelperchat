...
<?php if ($initial == true) : ?>
    <div class="alert alert-info" role="alert" style="margin:10px 10px 30px 10px;padding:5px" id="scroll-to-chat-<?php echo $chat->id?>-<?php echo $message_start?>">
        <p class="mb-0 text-center"><b><i class="material-icons">&#xE316;</i><i class="material-icons">&#xE316;</i><i class="material-icons">&#xE316;</i> <i class="material-icons fs24">&#xE889;</i> End of the chat - <?php echo $chat->id?> <i class="material-icons">&#xE316;</i><i class="material-icons">&#xE316;</i><i class="material-icons">&#xE316;</i></b></p>
    </div>
<?php elseif (isset($chat) && isset($chat_history) && is_object($chat) && is_object($chat_history) && $chat->id != $chat_history->id ) : ?>
    ...
    <div class="alert alert-info" role="alert" style="margin:10px 10px 30px 10px;padding:5px" id="scroll-to-chat-<?php echo $chat->id?>-<?php echo $message_start?>">
        <p class="mb-0 text-center"><b>
                ...
                <i class="material-icons">&#xE316;</i>
                <i class="material-icons">&#xE316;</i>
                <i class="material-icons fs24">&#xE889;</i> End of the chat - <?php echo $chat->id?>
                <i class="material-icons">&#xE316;</i>
                <i class="material-icons">&#xE316;</i>
                <i class="material-icons">&#xE316;</i>
            </b>
