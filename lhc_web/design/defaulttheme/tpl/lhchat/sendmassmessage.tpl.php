            ...
            <script>
                (function(){
                    ...
                    function updateFilter(){
                        $.get(WWW_DIR_JAVASCRIPT + 'chat/onlineusers/(method)/ajax/(timeout)/2678400/(maxrows)/50/'+($('#id_mass_country_id').val() != '' ? '/(country)/'+$('#id_mass_country_id').val() : '')+(parseInt($('#id_mass_department_id').val()) > 0 ? '/(department)/'+$('#id_mass_department_id').val() : '')+"?view=html", function(data) {
                    ...
                    $('#id_mass_department_id,#id_mass_country_id').change(function(){
                        updateFilter()
                    });
