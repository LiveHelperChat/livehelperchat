...
<select name="DepartamentID">
    <?php foreach (erLhcoreClassDepartament::getDepartaments() as $departament) : ?>
        <option value="<?php echo $departament['id']?>" <?php isset($input_data->departament_id) && $input_data->departament_id == $departament['id'] ? print 'selected="selected"' : '';?> ><?php echo $departament['name']?></option>
    <?php endforeach; ?>
</select>
<?php endif; ?> 