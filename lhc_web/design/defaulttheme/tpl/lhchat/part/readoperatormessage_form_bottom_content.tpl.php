<textarea class="form-control form-control-sm form-group <?php if ($hasExtraField !== true) : ?>border-top-0 btrad-reset mb-0<?php endif;?>" placeholder="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','Type your message here and hit enter to send...');?>" id="id_Question" name="Question"><?php echo htmlspecialchars($input_data->question);?></textarea>
