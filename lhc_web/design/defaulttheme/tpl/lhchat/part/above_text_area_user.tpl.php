...
<div class="user-chatwidget-buttons" id="ChatSendButtonContainer">
    ...
    <a class="send-icons-action"  href="#" onclick="lhinst.addmsguser(true)" title="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/chat','Send')?>"><i class="material-icons">send</i></a>
