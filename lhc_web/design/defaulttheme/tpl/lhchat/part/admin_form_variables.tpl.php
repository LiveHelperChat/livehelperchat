        ...
        <?php elseif ($adminField['fieldtype'] == 'dropdown') : ?>
            ...
            <div class="col-<?php echo htmlspecialchars($adminField['size'])?>">
                <div class="form-group">
                    ...
                    <select name="value_items_admin[<?php echo $key?>]" class="form-control<?php if (isset($errors['additional_admin_'.$key])) : ?> is-invalid<?php endif;?>">
