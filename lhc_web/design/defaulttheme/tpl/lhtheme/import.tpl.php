...
<form action="" method="post" autocomplete="off" enctype="multipart/form-data">
	...
	<input type="submit" name="ImportTheme" class="btn btn-sm btn-secondary" value="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('theme/import','Import')?>" />
