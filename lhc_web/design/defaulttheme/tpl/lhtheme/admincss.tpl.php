...
<div class="msgBlock" style="" id="messagesBlock">
    <div class="message-row response" id="msg-10459" data-op-id="0">
        ...
        <span style="color:#{{bactract_bg_color_buble_visitor_title_color}}" class="usr-tit vis-tit" role="button"><i class="material-icons chat-operators mi-fs15 mr-0">&#xf004;</i>Operator</span>
    ...
    <div class="message-row message-admin operator-changes" id="msg-10463" data-op-id="1">
        ...
        <span style="color:#{{bactract_bg_color_buble_operator_title_color}}" class="usr-tit op-tit" ><i class="material-icons chat-operators mi-fs15 mr-0">&#xf643;</i>Visitor</span>
