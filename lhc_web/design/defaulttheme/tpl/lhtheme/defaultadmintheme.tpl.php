...
<form action="" method="post" autocomplete="off" enctype="multipart/form-data">
	...
	<div class="form-group">
        ...
        <select name="ThemeID" class="form-control form-control-sm" ng-non-bindable>
            <option value="0">--<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/htmlcode','Default');?>--</option>
    		<?php foreach (erLhAbstractModelAdminTheme::getList(array('limit' => false, 'sort' => '`name` ASC','filter' => array('user_id' => 0))) as $theme) : ?>
