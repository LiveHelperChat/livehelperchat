	...
	<div class="col-6">
		<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-6">
					<input type="button" class="btn btn-secondary col-12" ng-click="cform.<?php echo $paramsResourceAdd['add_function']?>()" value="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchatformsettings','Add resource')?>" />
				</div>
			</div>
		</div>
	</div>
