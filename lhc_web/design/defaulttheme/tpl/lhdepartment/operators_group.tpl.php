    ...
    <div class="modal-body" ng-non-bindable>
        <div class="p-2">
            ...
            <table class="table table-sm table-hover">
                ...
                <?php foreach (erLhcoreClassModelUserDep::getList(['sort' => 'user_id ASC, type ASC','filter' => ['dep_group_id' => $department_group->id], 'limit' => false]) as $member) : ?>
                    <tr>
                        ...
                        <td>
                           <?php echo htmlspecialchars(erLhcoreClassModelDepartament::fetch($member->dep_id))?>
                        </td>
                        <td>
