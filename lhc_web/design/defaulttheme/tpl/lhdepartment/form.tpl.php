			...
			<div role="tabpanel" class="tab-pane active" id="onlinehours">
		    	...
		    	<div ng-show="OnlineHoursActive">
                    ...
                    <ul>
                        ...
                        <li><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('department/edit','Widget time zone');?> - <?php echo erConfigClassLhConfig::getInstance()->getSetting( 'site', 'time_zone' )?> <?php echo (new DateTime('now', new DateTimeZone(erConfigClassLhConfig::getInstance()->getSetting( 'site', 'time_zone' ))))->format('Y-m-d H:i:s') ?></li>
                    ...
                    <p><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('department/edit','These hours will be using');?>  <?php echo erConfigClassLhConfig::getInstance()->getSetting( 'site', 'time_zone' )?> <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('department/edit','time zone');?> <b>[<?php echo (new DateTime('now', new DateTimeZone(erConfigClassLhConfig::getInstance()->getSetting( 'site', 'time_zone' ))))->format('Y-m-d H:i:s') ?>]</b> <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('department/edit','to render widget online status');?></p>
