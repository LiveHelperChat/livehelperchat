...
<?php foreach ($items as $departament) : ?>
    <tr>
        ...
        <td><?php if ($departament->pending_max == 0 || $departament->pending_max > $departament->pending_chats_counter) : ?><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('department/departments','No');?><?php else : ?><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('department/departments','Yes');?><?php endif;?></td>
