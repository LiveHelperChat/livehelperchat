...
var lhc_FAQ = function() {
   ...
   function appendHTML(htmlStr) {
	...
	this.showVotingForm = function() {
   		  ...
   		  this.initial_iframe_url = "<?php echo erLhcoreClassSystem::instance()->baseHTTP?><?php echo $_SERVER['HTTP_HOST']?><?php echo erLhcoreClassDesign::baseurl('faq/faqwidget')?>"+'?URLReferer='+escape(document.location)+'&URLModule='+LHCFAQOptions.url;

   		  this.iframe_html = '<iframe allowTransparency="true" scrolling="yes" class="loading" frameborder="0" ' +
                       ( this.initial_iframe_url != '' ? ' src="'    + this.initial_iframe_url + '"' : '' ) +
                       ' width="520"' +
                       ' height="350"' +
                       ' style="width: 490px; height: 370px;"></iframe>';
