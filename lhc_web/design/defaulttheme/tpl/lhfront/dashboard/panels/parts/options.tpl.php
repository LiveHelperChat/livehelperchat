<div class="p-<?php isset($optinsPanel['padding_filters']) ? print ((int)$optinsPanel['padding_filters']) : print 2;?>">
	<div class="row">
		<div class="col-<?php isset($optinsPanel['userid']) ? print 6 : print (!isset($optinsPanel['hide_limits']) ? 10 : 12)?> pr-0">
