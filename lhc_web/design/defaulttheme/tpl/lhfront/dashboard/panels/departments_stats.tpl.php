		...
		<div class="panel-list">
			<table class="table table-sm mb-0 table-small table-fixed">
                ...
                <tr ng-if="!lhc.departmentd_hide_dgroup" ng-repeat="depgroup in depgroups_stats.list track by depgroup.id">
                    ...
                    <td nowrap title="{{depgroup.inachats_cnt ? depgroup.inachats_cnt : 'n/a'}} inactive chats.<?php echo "\n"?>{{depgroup.inopchats_cnt ? depgroup.inopchats_cnt : 'n/a'}} inactive online operators chats.<?php echo "\n"?>{{depgroup.acopchats_cnt ? depgroup.acopchats_cnt : 'n/a'}} active online operators chats.<?php echo "\n"?><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('pagelayout/pagelayout','Hard limit');?> - {{depgroup.max_load_h ? depgroup.max_load_h : 'n/a'}}, <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('pagelayout/pagelayout','Soft limit');?> - {{depgroup.max_load ? depgroup.max_load : 'n/a'}}.<?php echo "\n"?><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('pagelayout/pagelayout','Hard limit - (active online operators chats - inactive online operators chats) (soft limit - active chats)');?>"><span ng-class="{'text-danger font-weight-bold': (depgroup.max_load_h && depgroup.max_load_h - (depgroup.acopchats_cnt - (depgroup.inopchats_cnt ? depgroup.inopchats_cnt : 0)) <= 3)}">{{depgroup.max_load_h ? (depgroup.max_load_h - (depgroup.acopchats_cnt - (depgroup.inopchats_cnt ? depgroup.inopchats_cnt : 0))) : 'n/a'}}</span>&nbsp;({{depgroup.max_load ? (depgroup.max_load - (depgroup.achats_cnt - (depgroup.inachats_cnt ? depgroup.inachats_cnt : 0))) : 'n/a'}})</td>
                </tr>
				...
				<tr ng-if="!lhc.departmentd_hide_dep" ng-repeat="department in departments_stats.list track by department.id">
                    ...
                    <td nowrap title="{{department.inactive_chats_cnt ? department.inactive_chats_cnt : 'n/a'}} inactive chats.<?php echo "\n"?>{{department.inop_chats_cnt ? department.inop_chats_cnt : 'n/a'}} inactive online operators chats.<?php echo "\n"?>{{department.acop_chats_cnt ? department.acop_chats_cnt : 'n/a'}} active online operators chats.<?php echo "\n"?><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('pagelayout/pagelayout','Hard');?> - {{department.max_load_h ? department.max_load_h : 'n/a'}}, <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('pagelayout/pagelayout','Soft');?> - {{department.max_load ? department.max_load : 'n/a'}}.<?php echo "\n"?><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('pagelayout/pagelayout','Hard limit - (active online operators chats - inactive online operators chats) (soft limit - active chats)');?>"><span ng-class="{'text-danger font-weight-bold': (department.max_load_h && department.max_load_h - (department.acop_chats_cnt - (department.inop_chats_cnt ? department.inop_chats_cnt : 0)) <= 3)}">{{department.max_load_h ? (department.max_load_h - (department.acop_chats_cnt - (department.inop_chats_cnt ? department.inop_chats_cnt : 0))) : 'n/a'}}</span>&nbsp;({{department.max_load ? (department.max_load - (department.active_chats_counter - (department.inactive_chats_cnt ? department.inactive_chats_cnt : 0))) : 'n/a'}})</td>
