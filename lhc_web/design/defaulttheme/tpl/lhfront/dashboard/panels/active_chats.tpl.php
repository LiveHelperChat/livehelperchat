<?php if ($currentUser->hasAccessTo('lhchat','use')) : ?>
    ...
    <lhc-widget type="active_chats" sort_identifier="active_chats_sort" icon_class="chat-active" type="active_chats" status_id="1" expand_identifier="activec_widget_exp" list_identifier="active-chats" panel_list_identifier="actived-panel-list" optionsPanel={"panelid":"actived","limitid":"limita","userid":"activeu"} www_dir_flags="<?php echo erLhcoreClassDesign::design('images/flags');?>"></lhc-widget>
