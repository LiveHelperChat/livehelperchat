					...
					<tr ng-repeat="ou in group.ou | orderBy:online.predicate:online.reverse | filter:query track by ou.id" id="uo-vid-{{ou.vid}}" class="online-user-filter-row" ng-class="{<?php echo $onlineCheck?>}">
						<td nowrap="nowrap">
							<div class="btn-group" role="group" aria-label="...">
                                <a href="#" class="btn btn-xs btn-outline-secondary" title="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('user/account','Copy nick');?>" onclick="lhinst.copyContent($(this))" data-success="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('user/account','Copied');?>" data-copy="{{ou.nick}}"><i class="material-icons mr-0">content_copy</i></a>
