...
<ul>
    <li><b><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('module/mailconvprint','From');?></b> <?php echo htmlspecialchars($chat->from_name)?> &lt;<?php echo htmlspecialchars(!erLhcoreClassUser::instance()->hasAccessTo('lhmailconv','mail_see_unhidden_email') ? \LiveHelperChat\Helpers\Anonymizer::maskEmail($chat->from_address) : $chat->from_address)?>&gt; <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('module/mailconvprint','at');?> <?php echo htmlspecialchars($chat->udate_front)?></li>
