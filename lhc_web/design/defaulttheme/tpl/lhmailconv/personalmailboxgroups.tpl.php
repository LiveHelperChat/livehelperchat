            ...
            <tr>
                ...
                <td>
                    <div class="btn-group" role="group" aria-label="..." style="width:60px;">
                        <a class="btn btn-secondary btn-xs" href="<?php echo erLhcoreClassDesign::baseurl('mailconv/editpersonalmailboxgroup')?>/<?php echo $item->id?>" ><i class="material-icons mr-0">&#xE254;</i></a>
