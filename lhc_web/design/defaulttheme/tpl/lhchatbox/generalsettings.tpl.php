...
<label><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chatbox/generalsettings','Messages limit in chatbox');?></label>
...
<label class="inline"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chatbox/generalsettings','Auto creation by chatbox identifier enabled'); ?> <input type="checkbox" name="AutoCreation" value="1" <?php isset($chatbox_data['chatbox_auto_enabled']) && ($chatbox_data['chatbox_auto_enabled'] == '1') ? print 'checked="checked"' : '' ?> /></label>

<label><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chatbox/generalsettings','Secret hash, used then auto creation is disabled');?>, <a href="http://livehelperchat.com/documentation-6c.html"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chatbox/generalsettings','more information how to use it');?></a></label>
