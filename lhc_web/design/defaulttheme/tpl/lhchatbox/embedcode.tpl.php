...
<p class="explain"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/htmlcode','Copy code from the textarea to the page where you want it to be rendered');?></p>
