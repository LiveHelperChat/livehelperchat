<label class="col-form-label"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','Product');?>*</label>
<select class="form-control form-control-sm" name="ProductID" id="ProductID_id">
