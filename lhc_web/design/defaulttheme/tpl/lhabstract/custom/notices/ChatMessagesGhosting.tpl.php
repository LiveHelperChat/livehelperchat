<div class="alert fs13 alert-<?php echo (erLhcoreClassModelChatConfig::fetch('guardrails_enabled')->current_value != 1) ? 'warning' : 'success'; ?> mt-4">
    <p>
        ...
        <?php else : ?>
            <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('abstract/chatmessagesghosting','Message content protection rules are enabled for visitors and operators.');?>
        <?php endif; ?>
    </p>
