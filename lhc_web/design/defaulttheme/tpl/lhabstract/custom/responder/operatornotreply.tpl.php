...
<?php for ($i = 1; $i <= 5; $i++) : ?>
    <div class="row">
        ...
        <div class="col-9">
            <div class="form-group">
                <label><?php echo $fields['timeout_op_reply_message_' . $i]['trans'];?> <a href="#" onclick="lhc.revealModal({'url':WWW_DIR_JAVASCRIPT+'genericbot/help/cannedreplacerules'});" class="material-icons text-muted">help</a></label>
