...
<dl class="tabs">
  ...
  <dd <?php if ($tab == 'tab_departments') : ?>class="active"<?php endif;?>><a href="#simple2"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('user/account','Assigned departments');?></a></dd>
