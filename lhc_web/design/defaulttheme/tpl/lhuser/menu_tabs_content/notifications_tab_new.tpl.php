            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <br/><small><i><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/configuration','User will stop receiving notifications for pending chats if they are not an owner')?></i></small>
                    </div>
                ...
                <div class="col-6">
                    ...
                    <div class="form-group">
                        <label><input type="checkbox" name="trackactivity" value="on" <?php $quick_settings['trackactivity'] == 1 ? print 'checked="checked"' : '' ?>> <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/configuration','Change user online/offline status based on their activity')?></label>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control form-control-sm" name="trackactivitytimeout">
                            <option value="-1" <?php echo $quick_settings['trackactivitytimeout'] == -1 ? 'selected="selected"' : ''?>><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/configuration','Use default system value')?> (<?php echo (int)erLhcoreClassModelChatConfig::fetch('activity_timeout')->current_value?> <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/configuration','minutes')?>)</option>
