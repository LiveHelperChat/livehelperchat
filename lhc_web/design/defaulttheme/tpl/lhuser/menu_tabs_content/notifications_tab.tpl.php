                ...
                <div class="col-6">
                     ...
                     <div class="form-group">
                        ...
                        <select class="form-control form-control-sm" name="trackactivitytimeout">
                            ...
                            <option value="5" <?php echo erLhcoreClassModelUserSetting::getSetting('trackactivitytimeout',-1) == 5 ? 'selected="selected"' : ''?>>5 <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/configuration','seconds')?></option>
