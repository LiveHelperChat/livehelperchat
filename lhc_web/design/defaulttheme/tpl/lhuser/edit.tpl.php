...
<ul class="nav nav-tabs mb-3" role="tablist" data-remember="true">
    ...
    <?php if (erLhcoreClassUser::instance()->hasAccessTo('lhaudit','see_op_actions')) : ?>
        <li class="nav-item" role="presentation"><a class="nav-link <?php if ($tab == 'tab_opactions') : ?>active<?php endif;?>" href="<?php if ($tab == 'tab_opactions') : ?>#opactions<?php else : ?><?php echo erLhcoreClassDesign::baseurl('user/edit')?>/<?php echo $user->id?>/(tab)/opactions<?php endif;?>" <?php if ($tab == 'tab_opactions') : ?>data-bs-toggle="tab"<?php endif;?> aria-controls="opactions" role="tab" ><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('user/account','Actions');?></a></li>
    <?php endif;?>
...
<div class="tab-content">
	...
	<div role="tabpanel" class="tab-pane <?php if ($tab == '') : ?>active<?php endif;?>" id="account">
	   ...
	   <form action="<?php echo erLhcoreClassDesign::baseurl('user/edit')?>/<?php echo $user->id?>#account" method="post" autocomplete="off" enctype="multipart/form-data">
           ...
           <div class="row">
    		...
    		<div class="btn-group" role="group" aria-label="..." id="buttons-submit-group" >

                <?php if (!($can_edit_groups === false)) : ?>
                <input type="submit" class="btn btn-secondary" id="save-button-action" name="Save_account" value="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('user/edit','Save');?>"/>
    		    <input type="submit" class="btn btn-secondary" id="update-button-action" name="Update_account" value="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('user/edit','Update');?>"/>
                <?php endif; ?>
    ...
    <?php if (erLhcoreClassUser::instance()->hasAccessTo('lhaudit','see_op_actions') && $tab == 'tab_opactions') : ?>
        <div role="tabpanel" class="tab-pane <?php if ($tab == 'tab_opactions') : ?>active<?php endif;?>" id="opactions">
