...
<form ng-non-bindable action="" method="post" autocomplete="off">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="max_attempts" value="<?php (isset($password_data['max_attempts'])) ? print htmlspecialchars($password_data['max_attempts']) : print '' ?>" />
    </div>
    <div class="form-group">
