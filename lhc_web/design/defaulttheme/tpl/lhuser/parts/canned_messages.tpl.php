    ...
    <div class="tab-content">
        ...
        <div ng-repeat="lang in cmsg.languages" role="tabpanel" class="tab-pane" id="lang-{{$index}}">
            ...
            <div class="row mb-1">
                ...
                <div class="col-11"><input type="text" ng-init="cmsg.query = lang.languages.length == 0 ? '*' : ''" ng-model="cmsg.query" value="" placeholder="Search for language. Enter * to see all." class="form-control form-control-sm"></div>
            </div>
