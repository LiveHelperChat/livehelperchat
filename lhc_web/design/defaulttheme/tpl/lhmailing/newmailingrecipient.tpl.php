...
<form action="<?php echo erLhcoreClassDesign::baseurl('mailing/newmailingrecipient')?>" method="post" ng-non-bindable target="_blank" onsubmit="return lhinst.submitModalForm($(this))">
