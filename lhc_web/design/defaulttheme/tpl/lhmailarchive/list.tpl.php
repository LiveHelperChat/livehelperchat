...
<?php foreach ($items as $item) : ?>
    <tr>
        ...
        <?php if (erLhcoreClassUser::instance()->hasAccessTo('lhmailarchive','configuration')) : ?>
        <td nowrap="nowrap"><a class="btn btn-secondary btn-xs" href="<?php echo erLhcoreClassDesign::baseurl('mailarchive/process')?>/<?php echo $item->id?>"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chatarchive/list','Process again');?></a></td>
...
<?php endif;?>
<?php if (erLhcoreClassUser::instance()->hasAccessTo('lhmailarchive','configuration')) : ?>
<a class="btn btn-secondary" href="<?php echo erLhcoreClassDesign::baseurl('mailarchive/newarchive')?>"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chatarchive/archive','New archive');?></a>
<?php endif; ?>
