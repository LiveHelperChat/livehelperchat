...
<div class="row">
    <div class="col-xs-3">
        ...
        <div class="col-xs-5">
            <canvas id="myChart-<?php echo $starEnabled?>" width="400" height="300"></canvas>
        </div>
    <div class="col-xs-4">        
        ...
        <table class="table table-condensed">
            ...
            <tr>
                <td width="1%" nowrap><?php echo $i?> <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('survey/collected','Stars')?></td>
                <td>
                <?php
...
<script>
drawChart({data:[<?php echo $negativeChatsCount?>,<?php echo $positiveChatsCount?>],range:{pos:'<?php echo $negativeRange[0],'-',$negativeRange[1]?>',neg:'<?php echo $positiveRange[0],'-',$positiveRange[1]?>'}},<?php echo $starEnabled?>);
</script>
<hr>
<?php endforeach; ?>
