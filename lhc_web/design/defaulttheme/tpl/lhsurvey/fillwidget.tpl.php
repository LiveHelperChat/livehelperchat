    ...
    <div class="fill-survey-form">
        <form action="" method="post">
            ...
            <div class="btn-group" role="group" aria-label="...">
                ...
                <?php endif;?>
                <button type="button" class="btn btn-info btn-sm" onclick="return lhc.revealModal({'url':WWW_DIR_JAVASCRIPT+'chat/chatpreview/<?php echo $chat->id?>/<?php echo $chat->hash?>'})"><i class="material-icons">chat</i> <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('survey/fill','Review chat')?></button>
            </div>
