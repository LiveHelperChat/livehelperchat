    ...
    <div class="fill-survey-form">
        <form action="" method="post">
            ...
            <div class="btn-group" role="group" aria-label="...">
                ...
                <?php endif;?>
                    <a class="btn btn-info btn-sm" onclick="lhc.revealModal({'url':WWW_DIR_JAVASCRIPT+'chat/chatpreview/<?php echo $chat->id?>/<?php echo $chat->hash?>'})"><i class="material-icons">&#xfb55;</i> <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('survey/fill','Preview chat')?></a>
             </div>
        </form>
    </div>
</div>