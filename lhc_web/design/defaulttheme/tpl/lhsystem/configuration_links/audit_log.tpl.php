<?php if ($currentUser->hasAccessTo('lhabstract','use')) : ?>
    <?php if ($currentUser->hasAccessTo('lhsystem','auditlog')) : ?>
        ...
        <li><a href="<?php echo erLhcoreClassDesign::baseurl('audit/loginhistory')?>"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('system/configuration','Login history');?></a></li>
        <?php endif; ?>
    <?php endif; ?>
<?php endif;?>