...
<form action="" method="post">
    ...
    <div class="form-group">
        ...
        <textarea ng-non-bindable name="ga_js" class="form-control form-control-sm"><?php isset($ga_options['ga_js']) ? print htmlspecialchars($ga_options['ga_js']) : print "ga('send', 'event', { 'eventCategory': {{eventCategory}},'eventAction': {{eventAction}},'eventLabel': {{eventLabel}} })"?></textarea>
    </div>
        ...
        <div role="tabpanel" class="tab-pane <?php if ($tab == 'needhelp') : ?>active<?php endif;?>" id="needhelp">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <div class="form-group">
                        <label>Event action [eventAction]*</label>
                        <input type="text" class="form-control" name="nhClosed_action" value="<?php isset($ga_options['nhClosed_action']) ? print htmlspecialchars($ga_options['nhClosed_action']) : print 'Closed'?>" />
                    </div>
                </div>
                <div class="col-4">
                    <div class="form-group">
