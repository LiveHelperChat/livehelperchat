...
<div class="row">
    ...
    <div class="columns six">
        ...
        <select id="PositionID">
               <option value="original">Original placement</option>
...
function generateEmbedCode(){
    ...
    $('#HMLTContent').html('&lt;script type=&quot;text/javascript&quot; src=&quot;http://<?php echo $_SERVER['HTTP_HOST']?><?php echo erLhcoreClassDesign::baseurldirect()?>'+siteAccess+'chat/getstatus'+id_internal_popup+id_position+'&quot;&gt;&lt;/script&gt;');
}

$('#LocaleID,#id_internal_popup,#id_position_bottom,#PositionID').change(function(){    
    generateEmbedCode();
});
