...
<dl class="tabs" id="tabs">
  <dd class="active"><a href="#simple1"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('front/default','Standard embed');?></a></dd>
  <dd><a href="#simple2"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('front/default','Fixed bottom');?></a></dd>
</dl>
