...
<form action="" method="post" ng-non-bindable>
    ...
    <div class="tab-content">
        <div role="tabpanel" class="tab-pane <?php if ($tab == '') : ?>active<?php endif;?>" id="edit">
            <?php include(erLhcoreClassDesign::designtpl('lhnotifications/form_op.tpl.php'));?>
        ...
        <div role="tabpanel" class="tab-pane <?php if ($tab == 'tab_notification') : ?>active<?php endif;?>" id="notification">
            <?php include(erLhcoreClassDesign::designtpl('lhnotifications/form_test_op_notification.tpl.php'));?>
            <div class="btn-group" role="group" aria-label="...">
