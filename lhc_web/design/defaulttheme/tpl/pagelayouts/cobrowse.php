...
<head>
	...
	<script type="text/javascript" src="<?php echo erLhcoreClassDesign::designJS('js/cobrowse/compiled/cobrowse.operator.min.js;js/cobrowse/lhc_operator.js');?>"></script>
