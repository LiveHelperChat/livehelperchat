...
<li class="nav-item">
        <a href="#" class="nav-link"><i class="material-icons">&#xfb55;</i><span class="nav-link-text"><?php include(erLhcoreClassDesign::designtpl('pagelayouts/parts/sidemenu/chat/chat_title.tpl.php'));?></span><i class="material-icons arrow">&#xf142</i></a>
