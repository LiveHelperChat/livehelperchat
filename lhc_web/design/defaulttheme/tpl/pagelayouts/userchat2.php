...
if ($detect->version('IE') !== false) : ?>
    <script src="<?php echo erLhcoreClassDesign::design('js/widgetv2/react.app.ie.js')?>?t=82"></script>
<?php else : ?>
    <script src="<?php echo erLhcoreClassDesign::design('js/widgetv2/react.app.js')?>?t=82"></script>
<?php endif; ?>
