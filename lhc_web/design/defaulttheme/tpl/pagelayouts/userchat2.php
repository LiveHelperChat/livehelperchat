...
if ($detect->version('IE') !== false) : ?>
    <script src="<?php echo erLhcoreClassDesign::design('js/widgetv2/react.app.ie.js')?>?t=123"></script>
<?php else : ?>
    <script src="<?php echo erLhcoreClassDesign::design('js/widgetv2/react.app.js')?>?t=123"></script>
<?php endif; ?>
