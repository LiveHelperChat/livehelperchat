<p><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('genericbot/helpattributes', 'Describes how long chat took before it was closed. Chat duration is based on time spend between messages per agent.');?></p>
