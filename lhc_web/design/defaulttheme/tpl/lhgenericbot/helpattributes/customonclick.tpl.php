<?php if ($context == 'customonclick') : ?>
    <p><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('genericbot/helpattributes', 'You can have custom JS execution on click event. In combination with');?> <span class="badge badge-secondary"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('genericbot/helpattributes', 'Hide content on click');?></span> <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('genericbot/helpattributes', 'you can have your own invitation workflow.');?></p>
