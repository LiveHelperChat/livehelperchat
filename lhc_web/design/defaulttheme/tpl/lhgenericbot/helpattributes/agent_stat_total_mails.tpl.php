...
<ul>
        ...
        <ul>
            <li>New messages received by system from visitors is set to this status. They remain in this status untill operator. [RESPONSE_UNRESPONDED]
                <ul>
                    ...
                    <li>Operator replies to message by choosing No reply required option. In that scenario message changes status to (1) [RESPONSE_NOT_REQUIRED]</li>
                </ul>
            </li>
        </ul>
    </li>
    <li>
        (1) - No reply required
        <ul>
            <li>Sometimes visitor replies to our e-mail where visitor response does not require any feedback from us. In that scenario operator marks message as no reply required. So visitor message get's this status. [RESPONSE_NOT_REQUIRED]</li>
        </ul>
    </li>
    ...
    <li>(3) - Responded by e-mail
        <ul>
            <li>As soon operator writes response to visitor e-mail visitor message changes status to this to indicate it was responded. [RESPONSE_NORMAL]</li>
        </ul>
    </li>
</ul>
