    ...
    <div class="p-1">
        ...
        <div class="meta-auto-hide meta-message-<?php echo $messageId?>">
            ...
            <div class="btn-group" role="group" aria-label="...">
                ...
                <button type="button" class="btn btn-xs btn-warning" data-no-msg="true" data-id="<?php echo $messageId?>" data-payload="cancel_workflow" onclick="lhinst.buttonClicked('cancel_workflow',<?php echo $messageId?>,$(this))"><?php if (isset($metaMessageData['content']['collectable_options']['show_summary_cancel_name']) && !empty($metaMessageData['content']['collectable_options']['show_summary_cancel_name'])) : ?><?php echo htmlspecialchars($metaMessageData['content']['collectable_options']['show_summary_cancel_name'])?><?php else : ?><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('genericbot/list','Cancel')?><?php endif?></button>
            </div>
        </div>
        <?php endif; ?>
    </div>
