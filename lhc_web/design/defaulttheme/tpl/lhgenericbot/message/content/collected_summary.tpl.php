<div class="p5 meta-auto-hide">
    ...
    <div id="confirm-button-<?php echo $messageId?>" class="pb5 <?php if (isset($metaMessageData['content']['collectable_options']['show_summary_checkbox']) && $metaMessageData['content']['collectable_options']['show_summary_checkbox'] == true) : ?> hide<?php endif?>"><a class="btn btn-xs btn-info "  onclick="lhinst.buttonClicked('confirm',<?php echo $messageId?>)"><?php if (isset($metaMessageData['content']['collectable_options']['show_summary_confirm_name'])) : ?><?php echo htmlspecialchars($metaMessageData['content']['collectable_options']['show_summary_confirm_name'])?><?php else : ?>Confirm<?php endif?></a></div>
</div>
