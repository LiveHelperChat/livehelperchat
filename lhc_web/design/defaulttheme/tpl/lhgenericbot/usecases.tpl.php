                ...
                <div class="lhc-item-list">
                    <div class="lhc-item-list-title">
                        ...
                        <?php elseif ($item['type'] == 'trigger') : ?>
                            <i class="material-icons">action_key</i>  [<?php echo  $item['id']?>] <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('bot/conditions','Trigger');?> - <a targer="_blank" href="<?php echo erLhcoreClassDesign::baseurl('genericbot/bot')?>/<?php echo erLhcoreClassModelGenericBotTrigger::fetch($item['id'])->bot_id?>#!#/trigger-<?php echo $item['id']; ?>" class="text-decoration-none"><?php echo htmlspecialchars(erLhcoreClassModelGenericBotBot::fetch(erLhcoreClassModelGenericBotTrigger::fetch($item['id'])->bot_id)->name . ' -> ' . erLhcoreClassModelGenericBotTrigger::fetch($item['id'])->name)?></a>
