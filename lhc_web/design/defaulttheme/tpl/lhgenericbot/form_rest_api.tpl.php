    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane" id="body-rest-{{$index}}">
            ...
            <div ng-if="param.body_request_type == 'raw'">
                ...
                <div class="form-group">
                    <label><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('genericbot/restapi','Paste your request here (E.g JSON body). You can put visitor message as placeholder')?> <code ng-non-bindable>{{msg}}, {{chat_id}}</code></label>
        ...
        <div role="tabpanel" class="tab-pane" id="outputrest-rest-{{$index}}">
                ...
                <div ng-repeat="paramOutput in param.output" class="mt-2">
                    ...
                    <p><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('genericbot/restapi','If required you can have also condition to check')?></p>
                    <div class="row">
                        <div class="col-4">
                            <div class="form-group">
                                <label><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('genericbot/restapi','Response Location.')?></label>
