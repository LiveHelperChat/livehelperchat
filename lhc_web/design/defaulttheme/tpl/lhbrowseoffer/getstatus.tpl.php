...
var lhc_BrowseOffer = {
   ...
   reflow : function(){
         	...
         	document.getElementById('lhc_container_browseoffer').style.marginLeft = '-<?php echo $size/2,$units?>';
