...
<div class="row mb-2" ng-non-bindable>
    <div class="col-6">
        ...
        <?php foreach ($groups as $group) : ?>
            <a href="<?php echo erLhcoreClassDesign::baseurl('user/editgroup')?>/<?php echo $group->id?>" target="_blank" class="badge badge-secondary me-1"><?php echo htmlspecialchars($group)?></a>
        <?php endforeach; ?>
    </div>
    <div class="col-6">
        <h5><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('permission/explorer','Roles');?></h5>
        <?php foreach ($roles as $role) : ?>
            <a href="<?php echo erLhcoreClassDesign::baseurl('permission/editrole')?>/<?php echo $role->id?>" target="_blank" class="badge badge-secondary me-1"><?php echo htmlspecialchars($role)?></a>
        <?php endforeach; ?>
    </div>
</div>
