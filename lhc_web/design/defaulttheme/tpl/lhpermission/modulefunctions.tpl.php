...
<label class="fs12"><input class="mb0" type="checkbox" name="ModuleFunction[]" value="<?php echo $key?>"> <?php echo htmlspecialchars($Function['explain'])?> (<i><?php echo $key?></i>)</label><br>
<?php endforeach; ?>
<br/>