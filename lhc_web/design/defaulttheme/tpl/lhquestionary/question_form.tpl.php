...
<input ng-non-bindable class="form-control" type="text" name="Question" value="<?php echo htmlspecialchars($question->question);?>" />
</div>

<div class="form-group">
<label><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('questionary/form_question','Question intro');?></label>
<textarea ng-non-bindable class="form-control" name="QuestionIntro"><?php echo htmlspecialchars($question->question_intro);?></textarea>
</div>
...
<input type="text" ng-non-bindable class="form-control" name="Location" value="<?php echo htmlspecialchars($question->location);?>" />
</div>
...
<input ng-non-bindable type="text" ng-non-bindable class="form-control" name="Priority" value="<?php echo htmlspecialchars($question->priority);?>" />
</div>
...
<input ng-non-bindable type="text" class="form-control" name="Revote" value="<?php echo $question->revote;?>" />
</div>
