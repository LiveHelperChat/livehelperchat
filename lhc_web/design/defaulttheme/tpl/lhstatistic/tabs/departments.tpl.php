    ...
    <div class="row form-group">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <div class="btn-block-department">
                    <ul class="nav">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Choose department <span class="caret"></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <?php foreach (erLhcoreClassModelDepartament::getList() as $item) : ?>
                                    <li><label><input <?php if (is_array($input->department_ids) && in_array($item->id,$input->department_ids)) : ?>checked="checked"<?php endif;?> type="checkbox" name="department_ids[]" value="<?php echo $item->id?>"><?php echo htmlspecialchars($item->name)?></label></li>
                                <?php endforeach; ?>
                            </ul>
                        </li>
                    </ul>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <select name="timeintervalfrom_hours" class="form-control">
                    ...
                    <div class="col-md-6">
                        <select name="timeintervalfrom_minutes" class="form-control">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <select name="timeintervalto_hours" class="form-control">
                            <option value="">Select hour</option>
                            <?php for ($i = 0; $i <= 23; $i++) : ?>
                    ...
                    <div class="col-md-6">
                        <select name="timeintervalto_minutes" class="form-control">
                            <option value="">Select minute</option>
                            <?php for ($i = 0; $i <= 59; $i++) : ?>
