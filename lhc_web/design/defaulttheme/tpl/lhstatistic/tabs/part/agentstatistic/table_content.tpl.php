...
<td nowrap="nowrap"><a href="<?php echo erLhcoreClassDesign::baseurl('statistic/onlinehours')?><?php echo erLhcoreClassSearchHandler::getURLAppendFromInput($input);?>/(user_id)/<?php echo $info->userId?>"><?php echo $info->totalHoursOffline_front; ?></a></td>
<?php include(erLhcoreClassDesign::designtpl('lhstatistic/tabs/part/agentstatistic/table_content_after_offline_multiinclude.tpl.php'));?>
