...
<td nowrap="nowrap"><a href="<?php echo erLhcoreClassDesign::baseurl('chat/list')?><?php echo isset($input) ? erLhcoreClassSearchHandler::getURLAppendFromInput($input,false,array('user_ids')) : ''?>/(user_ids)/<?php echo $info->userId?>/(chat_status_ids)/2/(chat_duration_from)/1/(chat_duration_till)/3600"><?php echo $info->totalHours_front; ?></a>, <span class="text-muted" title="<?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/lists/search_panel','As participant')?>"><?php echo $info->totalHoursParticipant_front; ?></span></td>
