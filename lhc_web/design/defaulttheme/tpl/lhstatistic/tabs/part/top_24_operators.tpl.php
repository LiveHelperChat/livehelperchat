...
<tr>
	...
	<td>
	  <span class="up-voted"><i class="material-icons up-voted">&#xf514;</i><?php echo $operator->statistic_upvotes?></span>
	  <span class="down-voted"><i class="material-icons down-voted">&#xf512;</i><?php echo $operator->statistic_downvotes?></span>
	</td>
