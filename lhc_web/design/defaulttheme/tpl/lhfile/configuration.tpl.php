    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-6 mt-2">
                ...
                <label class="d-block"><input type="radio" name="chat_file_policy_v" <?php if (!isset($file_data['chat_file_policy_v']) || $file_data['chat_file_policy_v'] == 0) : ?>checked="checked"<?php endif;?> value="0"> <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('file/configuration','Always (default), generated link is valid for 5 minutes'); ?></label>
                <label class="d-block"><input type="radio" name="chat_file_policy_v" <?php if (isset($file_data['chat_file_policy_v']) && $file_data['chat_file_policy_v'] == 2) : ?>checked="checked"<?php endif;?> value="2"> <?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('file/configuration','Link is valid indefinitely'); ?></label>
                ...
                <h6><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('file/configuration','The image file can be downloaded by operator if'); ?> <a target="_blank" href="https://doc.livehelperchat.com/docs/bot/image-file-verification-flow"><span class="material-icons">help</span></a></h6>
