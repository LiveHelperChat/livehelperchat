<h3 style="font-size: 10px;"><?php echo erTranslationClassLhTranslation::getInstance()->getTranslation('chat/startchat','There are no online operators at the moment, please leave a message')?></h3>
...
<?php else : ?>
	...
	<div class="row">
	    ...
	    <div class="columns small-6 end">
	        ...
	        <input type="text" class="inputfield" name="Email" value="<?php echo htmlspecialchars($input_data->email);?>" placeholder="Ваш e-mail" style="width: 270px"/>
	    </div>
	</div>
