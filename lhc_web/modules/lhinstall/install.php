	    ...
	    if ($_SERVER['REQUEST_METHOD'] == 'POST')
	    {
            ...
            if (count($Errors) == 0) {
        	   ...
        	   $db->query("INSERT INTO `lh_chat_config` (`identifier`, `value`, `type`, `explain`, `hidden`) VALUES
                ...
                ('dashboard_order', 'online_operators,departments_stats|pending_chats,unread_chats|active_chats,closed_chats', '0', 'Home page dashboard widgets order', '0'),
                ...
                ('front_tabs', 'dashboard,online_users,online_map,pending_chats,active_chats,unread_chats,closed_chats,online_operators', '0', 'Home page tabs order', '0'),
