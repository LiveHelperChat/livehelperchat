...
$Result['path'] = [
	...
	['title' => erTranslationClassLhTranslation::getInstance()->getTranslation('chatbox/generalsettings', 'Paid chat settings')]
];

erLhcoreClassChatEventDispatcher::getInstance()->dispatch('paidchat.settings_path', ['result' => & $Result]);
