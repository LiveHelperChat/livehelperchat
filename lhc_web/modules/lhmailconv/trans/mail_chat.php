...
echo json_encode(array(
    "mail" => [
        ...
        "expand_all" => erTranslationClassLhTranslation::getInstance()->getTranslation('module/mailconv','Expand all'),
        "collapse_all" => erTranslationClassLhTranslation::getInstance()->getTranslation('module/mailconv','Collapse all'),
    ...
    "msg" => [
        "auto_replied" => erTranslationClassLhTranslation::getInstance()->getTranslation('module/mailconv','Auto-Replied - Automatic reply from recipient (vacation, out-of-office, delivery receipt). Not a personal reply.'),
