...
try {
	...
	{	
		...
		if ($chat->status != erLhcoreClassModelChat::STATUS_ACTIVE_CHAT && $chat->status != erLhcoreClassModelChat::STATUS_PENDING_CHAT && $chat->status != erLhcoreClassModelChat::STATUS_BOT_CHAT) {
