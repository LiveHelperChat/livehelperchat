...
if ($canListOnlineUsers == true || $canListOnlineUsersAll == true) {
	...
	erLhcoreClassChat::prefillGetAttributes($onlineOperators,array('free_slots','live_chats', 'last_accepted_ago','lastactivity_ago','max_chats','offline_since','ro','dep_id','user_id','id','name_official','pending_chats','inactive_chats','active_chats','departments_names','hide_online','avatar'),array(),array('filter_function' => true, 'remove_all' => true));
