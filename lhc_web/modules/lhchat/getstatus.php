...
$tpl->set('survey',is_numeric($Params['user_parameters_unordered']['survey']) && erLhAbstractModelSurvey::fetch($Params['user_parameters_unordered']['survey']) instanceof erLhAbstractModelSurvey ? (int)$Params['user_parameters_unordered']['survey'] : false);
