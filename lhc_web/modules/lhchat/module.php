...
$ViewList['start'] = array (
    'params' => array(),
    'uparams' => array('id','hash','department','theme','mobile','vid','identifier','inv','survey','priority','operator','leaveamessage'),
	'multiple_arguments' => array('department')
);
