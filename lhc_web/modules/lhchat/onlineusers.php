...
if ($is_ajax == true) {
	...
	erLhcoreClassModelChatOnlineUser::$trackActivity = (int)erLhcoreClassModelChatConfig::fetch('track_activity')->current_value == 1;
	erLhcoreClassModelChatOnlineUser::$trackTimeout = (int)erLhcoreClassModelChatConfig::fetch('checkstatus_timeout')->current_value;
