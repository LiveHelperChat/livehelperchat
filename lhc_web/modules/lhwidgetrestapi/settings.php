...
$outputResponse['static'] = array(
    ...
    'vendor' => $host . ((isset($_GET['ie']) && $_GET['ie'] == 'true') ? erLhcoreClassDesign::design('js/widgetv2/vendor.ie.js') . '?v=a9_' . $staticVersion : erLhcoreClassDesign::design('js/widgetv2/vendor.js') . '?v=a9_' . $staticVersion),
