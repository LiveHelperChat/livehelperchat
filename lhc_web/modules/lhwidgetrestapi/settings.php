...
// Wrapper version
$outputResponse['wv'] = 234;
 
// React APP versions
$outputResponse['v'] = 334;
...
$outputResponse['static'] = array(
    ...
    'vendor' => $host . ((isset($_GET['ie']) && $_GET['ie'] == 'true') ? erLhcoreClassDesign::design('js/widgetv2/vendor.ie.js') . '?v=a3' : erLhcoreClassDesign::design('js/widgetv2/vendor.js') . '?v=a4'),
