...
$outputResponse['static'] = array(
    ...
    'vendor_js' => erLhcoreClassModelChatConfig::fetch('explicit_http_mode')->current_value . '//' . $_SERVER['HTTP_HOST'] . ((isset($_GET['ie']) && $_GET['ie'] == 'true') ? erLhcoreClassDesign::design('js/widgetv2/vendor.ie.js') . '?v=2' : erLhcoreClassDesign::design('js/widgetv2/vendor.js') . '?v=2' ),
