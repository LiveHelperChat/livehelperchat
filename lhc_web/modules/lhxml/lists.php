...
$columnsToHide = array('user_id','status','dep_id','hash','user_status','support_informed','support_informed');
$columnsName = array('id' => 'ID','nick' => 'Nick','time' => 'Time','referrer' => 'Referrer','ip' => 'IP','email' => 'E-mail','name' => 'Department');
