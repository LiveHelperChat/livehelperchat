...
$onlineuserscolumnsToHide = array('dep_id','requires_email','invitation_seen_count','screenshot_id','operation','reopen_chat','vid','user_country_code','page_title','invitation_assigned','current_page', 'chat_id', 'operator_user_id', 'message_seen','operator_user_proactive','message_seen_ts','lat','lon','invitation_id','time_on_site','tt_time_on_site','invitation_count','store_chat');
