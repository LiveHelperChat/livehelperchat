...
foreach (['hide_online','all_departments','invisible_mode','inactive_mode','rec_per_req','max_active_chats','auto_accept','exclude_autoasign','attr_int_1','attr_int_2','attr_int_3','pswd_updated','always_on'] as $posAttr) {
    $def->properties[$posAttr] = new ezcPersistentObjectProperty();
    $def->properties[$posAttr]->columnName   = $posAttr;
    $def->properties[$posAttr]->propertyName = $posAttr;
