...
$def->table = "lh_abstract_saved_search";
$def->class = "erLhAbstractModelSavedSearch";
...
foreach (['position','user_id','days','updated_at','requested_at','total_records','passive','sharer_user_id','status'] as $posAttr) {
