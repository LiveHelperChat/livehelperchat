...
foreach (['icon_mode','position','enabled','chat_enabled','mail_enabled','online_enabled','has_popup','sort_enabled','chat_list_enabled','mail_list_enabled','chat_window_enabled'] as $posAttr) {
    $def->properties[$posAttr] = new ezcPersistentObjectProperty();
    $def->properties[$posAttr]->columnName   = $posAttr;
    $def->properties[$posAttr]->propertyName = $posAttr;
