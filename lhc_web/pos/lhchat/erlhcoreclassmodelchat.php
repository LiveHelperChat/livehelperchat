...
foreach (['uagent','chat_locale_to','chat_locale','screenshot_id','operation_admin','operation','chat_variables','additional_data','nick','status_sub_arg','hash','ip','email','phone','referrer','session_referrer','country_code','country_name','remarks','user_typing_txt','user_tz_identifier'] as $posAttr) {
