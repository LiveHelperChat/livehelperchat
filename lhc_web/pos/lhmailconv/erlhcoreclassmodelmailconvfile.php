...
foreach (['name','meta_msg','description','extension','type','attachment_id','file_path','file_name','content_id','disposition'] as $posAttr) {
...
foreach (['message_id','width','height','size','conversation_id'] as $posAttr) {
    $def->properties[$posAttr] = new ezcPersistentObjectProperty();
    $def->properties[$posAttr]->columnName   = $posAttr;
    $def->properties[$posAttr]->propertyName = $posAttr;
